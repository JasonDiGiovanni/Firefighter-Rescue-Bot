...
uint8_t lcd_reverseNibble(uint8_t x); // @suppress("Type cannot be resolved")
...
void lcd_gotoLine(uint8_t lineNum); // @suppress("Type cannot be resolved")

///Set cursor position - top left is 0,0
void lcd_setCursorPos(uint8_t x, uint8_t y); // @suppress("Type cannot be resolved")
...
void lcd_sendNibble(uint8_t theNibble); // @suppress("Type cannot be resolved") // @suppress("Type cannot be resolved")
